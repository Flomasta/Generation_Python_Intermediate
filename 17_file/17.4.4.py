with open('../txt_files_for_part_files_and_files_exam/class_scores.txt', 'r', encoding='utf-8') as data_file, open(
        '../txt_files_for_part_files_and_files_exam/new_scores', 'a', encoding='utf-8') as file:
