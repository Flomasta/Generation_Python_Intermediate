with open('../txt_files_for_part_files_and_files_exam/logfile.txt', 'r', encoding='utf-8') as logfile:
    ...
    for i in data:
        ...
        if diff >= 60:
            with open('../txt_files_for_part_files_and_files_exam/output_names.txt', 'a', encoding='utf-8') as output:
